...
import com.expediagroup.sdk.rapid.operations.GetCampaignsOperation
import com.expediagroup.sdk.rapid.operations.GetCampaignsOperationParams
...
import com.expediagroup.sdk.rapid.operations.GetPromotionsOperation
import com.expediagroup.sdk.rapid.operations.GetPromotionsOperationParams
...
class RapidClient private constructor(clientConfiguration: RapidClientConfiguration) : BaseRapidClient("rapid", clientConfiguration) {
     ...
     * @param campaignId The Merchandising `Campaign-Id` that was involved in the traveler shopping for these properties.  (optional)
     * @param customerIp IP address of the customer, as captured by your integration.<br> Ensure your integration passes the customer's IP, not your own. This value helps determine their location and assign the correct payment gateway.<br> Also used for fraud recovery and other important analytics.  (optional)
     * @param customerSessionId Insert your own unique value for each user session, beginning with the first API call. Continue to pass the same value for each subsequent API call during the user's session, using a new value for every new customer session.<br> Including this value greatly eases EPS's internal debugging process for issues with partner requests, as it explicitly links together request paths for individual user's session.  (optional)
     ...
     * @param operation [GetCampaignsOperation]
     * @throws ExpediaGroupApiErrorException
     * @return a [Response] object with a body of type kotlin.collections.List<Campaign>
     */
    fun execute(operation: GetCampaignsOperation): Response<kotlin.collections.List<Campaign>> = execute<Nothing, kotlin.collections.List<Campaign>>(operation)
     ...
     * @param operation [GetCampaignsOperation]
     * @throws ExpediaGroupApiErrorException
     * @return a [CompletableFuture<Response>] object with a body of type kotlin.collections.List<Campaign>
     */
    fun executeAsync(operation: GetCampaignsOperation): CompletableFuture<Response<kotlin.collections.List<Campaign>>> = executeAsync<Nothing, kotlin.collections.List<Campaign>>(operation)

    private suspend inline fun kgetCampaignsWithResponse(
        language: kotlin.String,
        customerSessionId: kotlin.String? =
            null,
        blockoutDates: kotlin.Boolean? =
            null,
        bookableEnd: kotlin.String? =
            null,
        bookableStart: kotlin.String? =
            null,
        lifetime: GetCampaignsOperationParams.Lifetime? =
            null,
        ...
        >? =
            null,
        minDiscount: kotlin.String? =
            null,
        stayEnd: kotlin.String? =
            null,
        stayStart: kotlin.String? =
            null,
        token: kotlin.String? =
            null,
        billingTerms: kotlin.String? =
        ...
        platformName: kotlin.String? =
            null
    ): Response<kotlin.collections.List<Campaign>> {
        val params =
     ...
     * @param customerSessionId Insert your own unique value for each user session, beginning with the first API call. Continue to pass the same value for each subsequent API call during the user's session, using a new value for every new customer session.<br> Including this value greatly eases EPS's internal debugging process for issues with partner requests, as it explicitly links together request paths for individual user's session.  (optional)
     * @param blockoutDates Specify restrictions to blockout dates.  If this parameter is not supplied, campaigns with and without blockout dates will be included. * `true` - Include only campaigns that have blockout dates. * `false` - Do not include campaigns that have blockout dates.  (optional)
     * @param bookableEnd Search for all campaigns with a `bookable_end` date equal to or before the specified date. (optional)
     ...
     * @param platformName This parameter is to specify what platform is being used to shop and book. If this field is needed, the value for this will be provided to you separately.  (optional)
     * @throws ExpediaGroupApiErrorException
     * @return kotlin.collections.List<Campaign>
     */
    @Throws(
        ExpediaGroupApiErrorException::class
    )
    @JvmOverloads
    @Deprecated("Use execute method instead", ReplaceWith("execute(operation: GetCampaignsOperation)"))
    fun getCampaigns(
        language: kotlin.String,
        customerSessionId: kotlin.String? =
            null,
        ...
        platformName: kotlin.String? =
            null
    ): kotlin.collections.List<Campaign> =
        getCampaignsWithResponse(
            language,
            customerSessionId,
            blockoutDates,
            bookableEnd,
    ...
    @JvmOverloads
    fun getPaginator(operation: GetCampaignsOperation): ResponsePaginator<kotlin.collections.List<Campaign>> {
        val response = execute(operation)
        return ResponsePaginator(this, response, emptyList()) { it.body<kotlin.collections.List<Campaign>>() }
    }

    @JvmOverloads
    @Deprecated("Use getPaginator method instead", ReplaceWith("getPaginator(operation: GetCampaignsOperation)"))
    fun getCampaignsPaginator(
        ...
        platformName: kotlin.String? =
            null
    ): Paginator<kotlin.collections.List<Campaign>> {
        val response =
            getCampaignsWithResponse(
                language,
                customerSessionId,
        ...
        return Paginator(this, response, emptyList()) { it.body<kotlin.collections.List<Campaign>>() }
    }

    @JvmOverloads
    @Deprecated("Use getPaginator method instead", ReplaceWith("getPaginator(operation: GetCampaignsOperation)"))
    fun getCampaignsPaginatorWithResponse(
        language: kotlin.String,
        customerSessionId: kotlin.String? =
            null,
        blockoutDates: kotlin.Boolean? =
        ...
        platformName: kotlin.String? =
            null
    ): ResponsePaginator<kotlin.collections.List<Campaign>> {
        val response =
            getCampaignsWithResponse(
                language,
                customerSessionId,
     ...
     * @param operation [GetPromotionsOperation]
     * @throws ExpediaGroupApiErrorException
     * @return a [Response] object with a body of type kotlin.collections.List<Promotion>
     */
    fun execute(operation: GetPromotionsOperation): Response<kotlin.collections.List<Promotion>> = execute<Nothing, kotlin.collections.List<Promotion>>(operation)
     ...
     * @param operation [GetPromotionsOperation]
     * @throws ExpediaGroupApiErrorException
     * @return a [CompletableFuture<Response>] object with a body of type kotlin.collections.List<Promotion>
     */
    fun executeAsync(operation: GetPromotionsOperation): CompletableFuture<Response<kotlin.collections.List<Promotion>>> = executeAsync<Nothing, kotlin.collections.List<Promotion>>(operation)

    private suspend inline fun kgetPromotionsWithResponse(
        language: kotlin.String,
        sortBy: GetPromotionsOperationParams.SortBy,
        customerSessionId: kotlin.String? =
            null,
        blockoutDates: kotlin.Boolean? =
            null,
        ...
        >? =
            null,
        membersOnly: kotlin.Boolean? =
            null,
        minAdvancePurchaseDays: kotlin.String? =
            null,
        minGuestRating: kotlin.String? =
            null,
        minStarRating: kotlin.String? =
            null,
        minStay: kotlin.String? =
            null,
        mobileOnly: kotlin.Boolean? =
            null,
        productLine: kotlin.collections.List<
            kotlin.String
        >? =
            null,
        promotionCriteria: kotlin.String? =
            null,
        propertyId: kotlin.collections.List<
            kotlin.String
        >? =
        ...
        platformName: kotlin.String? =
            null
    ): Response<kotlin.collections.List<Promotion>> {
        val params =
     ...
     * @param customerSessionId Insert your own unique value for each user session, beginning with the first API call. Continue to pass the same value for each subsequent API call during the user's session, using a new value for every new customer session.<br> Including this value greatly eases EPS's internal debugging process for issues with partner requests, as it explicitly links together request paths for individual user's session.  (optional)
     * @param blockoutDates Specify restrictions to blockout dates.  If this parameter is not supplied, promotions with and without blockout dates will be returned in the results. * `true` - Include only promotions that have blockout dates. * `false` - Include only promotions that do not have blockout dates.  (optional)
     * @param bookableEnd Search for promotions with a `bookable_end` date equal to or before the specified date. (optional)
     * @param bookableStart Search for promotions with a `bookable_start` date equal to or after the specified date. (optional)
     * @param campaignId Search for promotions with matching `campaign_id` values. You can provide 0 to 250 `campaign_id` parameters with different values, which will include promotions that match any of the requested values.  (optional)
     * @param categoryId Search for promotions associated with the specified `category_id` values. This parameter can be supplied multiple times with different values, which will include promotions that match any of the requested scenarios.  (optional)
     ...
     * @param minGuestRating Search for promotions that have a `min_guest_rating` equal to or larger than the value. (optional)
     * @param minStarRating Search for promotions that have a `min_star_rating` equal to or larger than the value. (optional)
     * @param minStay Search for promotions that have a `min_stay` equal to the passed in value. (optional)
     * @param mobileOnly Specify restrictions to `mobile_only` values.  If this parameter is not supplied, promotions with true or false will be returned in the results. * `true` - Only results with `mobile_only` equal to true will be returned. * `false` - Only results with `mobile_only` equal to false will be returned.  (optional)
     * @param productLine Search for promotions with a `product_line` that matches the value. This parameter can be supplied multiple times with different values, which will include promotions that match any of the requested scenarios.  (optional)
     * @param promotionCriteria Search for promotions that meet the criteria provided. This criteria is defined as:   * type,value For now the only type available will be `percentage` but other types will be added in the future.  (optional)
     * @param propertyId Search for promotions with matching `property_id` values. You can provide 0 to 250 `property_id` parameters with different values, which will include promotions that match any of the requested values.  (optional)
     * @param regionId Search for promotions associated with the specified `region_id` values. This parameter can be supplied multiple times with different values, which will include promotions that match any of the requested scenarios.  (optional)
     * @param stayEnd Search for all promotions with a `stay_end` date equal to or before the specified date. (optional)
     * @param stayStart Search for all promotions with a `stay_start` date equal to or after the specified date. (optional)
     ...
     * @param platformName This parameter is to specify what platform is being used to shop and book. If this field is needed, the value for this will be provided to you separately.  (optional)
     * @throws ExpediaGroupApiErrorException
     * @return kotlin.collections.List<Promotion>
     */
    @Throws(
        ExpediaGroupApiErrorException::class
    )
    @JvmOverloads
    @Deprecated("Use execute method instead", ReplaceWith("execute(operation: GetPromotionsOperation)"))
    fun getPromotions(
        language: kotlin.String,
        sortBy: GetPromotionsOperationParams.SortBy,
        customerSessionId: kotlin.String? =
        ...
        platformName: kotlin.String? =
            null
    ): kotlin.collections.List<Promotion> =
        getPromotionsWithResponse(
            language,
            sortBy,
            customerSessionId,
            blockoutDates,
    ...
    @JvmOverloads
    fun getPaginator(operation: GetPromotionsOperation): ResponsePaginator<kotlin.collections.List<Promotion>> {
        val response = execute(operation)
        return ResponsePaginator(this, response, emptyList()) { it.body<kotlin.collections.List<Promotion>>() }
    }

    @JvmOverloads
    @Deprecated("Use getPaginator method instead", ReplaceWith("getPaginator(operation: GetPromotionsOperation)"))
    fun getPromotionsPaginator(
        ...
        platformName: kotlin.String? =
            null
    ): Paginator<kotlin.collections.List<Promotion>> {
        val response =
            getPromotionsWithResponse(
                language,
                sortBy,
        ...
        return Paginator(this, response, emptyList()) { it.body<kotlin.collections.List<Promotion>>() }
    }

    @JvmOverloads
    @Deprecated("Use getPaginator method instead", ReplaceWith("getPaginator(operation: GetPromotionsOperation)"))
    fun getPromotionsPaginatorWithResponse(
        language: kotlin.String,
        sortBy: GetPromotionsOperationParams.SortBy,
        customerSessionId: kotlin.String? =
            null,
        ...
        platformName: kotlin.String? =
            null
    ): ResponsePaginator<kotlin.collections.List<Promotion>> {
        val response =
            getPromotionsWithResponse(
                language,
                sortBy,
