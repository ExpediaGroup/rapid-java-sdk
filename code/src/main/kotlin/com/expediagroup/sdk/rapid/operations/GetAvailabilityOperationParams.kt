...
data class GetAvailabilityOperationParams
    ...
    OperationParams {
        ...
        enum class Include(
            ...
            ROOMS_PERIOD_RATES_PERIOD_HOLDABLE("rooms.rates.holdable"),
