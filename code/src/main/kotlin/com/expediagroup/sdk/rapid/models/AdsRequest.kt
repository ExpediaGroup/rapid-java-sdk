...
data class AdsRequest(
    ...
    @JsonProperty("traveler_location")
    @field:NotNull
    @field:Valid
    val travelerLocation: Coordinates1,
    ...
    class Builder(
        ...
        private var travelerLocation: Coordinates1? = null,
        ...
        fun travelerLocation(travelerLocation: Coordinates1) = apply { this.travelerLocation = travelerLocation }
