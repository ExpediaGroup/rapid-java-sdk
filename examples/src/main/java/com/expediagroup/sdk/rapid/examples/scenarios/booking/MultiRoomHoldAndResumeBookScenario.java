...
public class MultiRoomHoldAndResumeBookScenario implements RapidScenario {
    ...
    public void run() {
        ...
        roomPriceCheck = shopService.checkRoomPrices(propertyAvailability, 0, 0).getBody();
        ...
        ItineraryCreation itineraryCreation = bookService.createBookingWithHold(roomPriceCheck, occupancy).getBody();
        ...
        Itinerary itinerary = bookService.getReservationByItineraryId(itineraryCreation).getBody();
