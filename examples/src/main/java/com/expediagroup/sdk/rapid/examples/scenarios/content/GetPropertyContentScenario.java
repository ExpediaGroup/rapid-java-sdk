...
/**
 * Scenario to get property content using the ContentService.
 */
public class GetPropertyContentScenario implements RapidScenario {
   ...
   *
   * @param rapidPartnerSalesProfile the profile to set
   */
  @Override
  ...
  /**
   * Runs the scenario to get property content.
   */
  @Override
  public void run() {
    ...
    Map<String, PropertyContent> propertyContentMap =
        contentService.getPropertyContent(Arrays.asList(Constants.TEST_PROPERTY_ID),
