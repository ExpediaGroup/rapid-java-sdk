...
public class GetPaymentOptionsOfRoomScenario implements RapidScenario {
    ...
    public void run() {
        ...
        List<com.expediagroup.sdk.rapid.models.Property> propertyAvailabilityList = shopService.getPropertiesAvailability(Arrays.asList("2"), this.rapidPartnerSalesProfile).getData();
        ...
        if (!(propertyAvailabilityList.get(0) instanceof com.expediagroup.sdk.rapid.models.PropertyAvailability)) {
            throw new IllegalStateException("Property is not of type PropertyAvailability");
        }

        com.expediagroup.sdk.rapid.models.PropertyAvailability propertyAvailability = (com.expediagroup.sdk.rapid.models.PropertyAvailability) propertyAvailabilityList.get(0);

        com.expediagroup.sdk.rapid.models.RoomAvailability selectedRoomAvailability = propertyAvailability.getRooms().get(0);
        ...
        shopService.getPaymentOptions(selectedRoomAvailability, this.rapidPartnerSalesProfile)
                .thenAccept(paymentOptionResponse -> {
                    com.expediagroup.sdk.rapid.models.PaymentOption paymentOption = paymentOptionResponse.getData();
